...
enum Constants {
    enum Globals {
        static let INSTRUMENTATION_NAME = "webfunny-ios"
        static let UNKNOWN_APP_NAME = "unknown-app"
    }
    enum SpanNames {
        static let SPLUNK_RUM_INITIALIZE = "WebfunnyRum.initialize"
    ...
    enum AttributeNames {
        ...
        static let SPLUNK_RUM_SESSION_ID = "webfunny.rumSessionId"
        static let SPLUNK_RUM_PREVIOUS_SESSION_ID = "webfunny.rum.previous_session_id"
        static let SPLUNK_RUM_VERSION = "webfunny.rumVersion"
    }
}
